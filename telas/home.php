                ...
                <div id="mainSlider" class="carousel slide" data-ride="carousel">
                   ...
                   <div class="carousel-inner">
                       <div class="carousel-item active">
                           <img src="../imagens/1.jpg" class="d-block w-100" alt="Veterinário">
                           <div class="carousel-caption d-md-block">
                               <h2>Veterinário</h2>
                               <p>Nós cuidamos do seu pet como se fosse nosso.</p>
                           </div>
                       </div>
                       ...
                       <div class="carousel-item">
                           ...
                           <div class="carousel-caption d-md-block">
                               ...
                               <p>A nossa loja conta com uma variedade de brinquedos, roupas e acessórios incríveis para seu pet.</p>
                           </div>
                       </div>
                   </div>
            ...
            <div id="about-area">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <img class="img-fluid" src="../imagens/avatar.png" alt="Agência hDC">
                        </div>
                        <div class="col-md-6">
                            <h3 class="about-title">Um petshop preocupado com seu cliente</h3>
                            <p>Nossa missão é muito mais que ser simplesmente um negócio pet. </br>
                            Nosso objetivo maior, é encantar os tutores e seus filhos de patas </br>
                            com uma experiência emocional positiva… Ajudar “pais e mães” de </br> 
                            pets a melhorarem a saúde e qualidade de vida de seus peludos.</p>
                            <p>Veja nossos diferenciais:</p>
                            <ul id="about-list">
                                <li><i class="fas fa-check"></i> Variados tipos de ração e petiscos.</li>
        ...
        <footer>
            <div id="contact-area">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-3 contact-box">
                            <i class="bx bx-map"></i>
                            <p><span class="contact-tile">Endereço:</span> Rua Santos Dumont, 343, Centro - Tubarão, SC</p>
                        </div>
            ...
            <div id="copy-area">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <p>Desenvolvido por <a href="https://www.linkedin.com/in/jonatas-severino-5a2855180/" target="_blank">Jonatas Severino</a>, <a href="https://www.linkedin.com/in/vin%C3%ADcius-brigido-721673212/" target="_blank">Vinícius Brigido</a>, 2021</p>
                        </div>
                    </div>
                </div>
            </div>
